  ...
  return (
    <section className=" h-[600px]  bg-gradient-to-b from-black to-[#280c44] md:h-[902px]">
      <div className="container mx-auto bg-red-400 md:relative">
        ...
        <Image
          className="lg:top-1/6 absolute left-0 top-72 w-[350px] sm:top-60 sm:w-[600px] md:left-8  "
          alt=""
          src={LeftHand}
        />
        <Image
          className="lg:top-1/6 absolute right-0 top-72  w-[350px] sm:top-60 sm:w-[600px] md:right-8"
          alt=""
          src={RightHand}
        />
      </div>
      <div className="absolute left-1/2 top-[50px] -translate-x-1/2 transform min-[340px]:top-[64px] lg:top-40">
        {children}
      </div>
    </section>
  )
